...
async def run_test():
    ...
    try:
        ...
        # -> Resize window to tablet dimensions and verify UI adapts correctly.
        await page.goto('http://localhost:8080/', timeout=10000)
        await asyncio.sleep(3)
        

        # -> Resize the window to tablet dimensions and verify UI adapts correctly with all controls accessible and usable.
        await page.goto('http://localhost:8080/', timeout=10000)
        await asyncio.sleep(3)
        

        # -> Simulate or resize to smartphone screen size and verify UI renders correctly with appropriate tap targets and visibility.
        ...
        frame = context.pages[-1]
        # Click احسب button to verify functionality on desktop before resizing
        ...
        # -> Resize or simulate smartphone screen size and verify UI renders correctly with appropriate tap targets and visibility, maintaining Neon Pulse theme clarity.
        await page.goto('http://localhost:8080/', timeout=10000)
        await asyncio.sleep(3)
