...
async def run_test():
    ...
    try:
        ...
        # -> Perform various calculations to trigger UI updates and observe animations for smoothness and absence of glitches.
        frame = context.pages[-1]
        # Input 30 in the percentage field to trigger calculation.
        ...
        frame = context.pages[-1]
        # Input 1500 in the number field to trigger calculation.
        ...
        frame = context.pages[-1]
        # Click the calculate button to perform the calculation and trigger UI updates.
        elem = frame.locator('xpath=html/body/div/div/div/section/form/div[3]/button[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Perform additional calculations with different values to further verify animation smoothness and visual consistency.
        frame = context.pages[-1]
        # Input 50 in the percentage field to trigger calculation.
        elem = frame.locator('xpath=html/body/div/div/div/section/form/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('50')
        

        frame = context.pages[-1]
        # Input 2000 in the number field to trigger calculation.
        elem = frame.locator('xpath=html/body/div/div/div/section/form/div/div[2]/input').nth(0)
        ...
        await expect(frame.locator('text=50% من 2000').first).to_be_visible(timeout=30000)
        await expect(frame.locator('text=١٬٠٠٠').first).to_be_visible(timeout=30000)
