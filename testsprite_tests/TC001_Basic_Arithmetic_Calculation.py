...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the calculator section to input '3 + 5' using on-screen buttons.
        frame = context.pages[-1]
        # Click on the 'آلة حاسبة' (Calculator) button to open the calculator interface
        elem = frame.locator('xpath=html/body/div/div/div/nav/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Input '3 + 5' using on-screen buttons.
        frame = context.pages[-1]
        # Click button '3'
        ...
        # -> Clear input by clicking 'C' button.
        frame = context.pages[-1]
        # Click 'C' button to clear input
        ...
        # -> Input '8 / 2' using buttons and calculate result.
        frame = context.pages[-1]
        # Click button '8'
        elem = frame.locator('xpath=html/body/div/div/div/section[2]/div/button[15]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        # -> Clear input by clicking 'C' button and retry input '8 / 2' using correct buttons, then calculate result.
        frame = context.pages[-1]
        # Click 'C' button to clear input
        elem = frame.locator('xpath=html/body/div/div/div/section[2]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
