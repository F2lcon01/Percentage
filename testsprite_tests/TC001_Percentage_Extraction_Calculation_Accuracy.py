...
async def run_test():
    ...
    try:
        ...
        # -> Input '20' in the percentage input field.
        ...
        # -> Input '200' in the number input field.
        frame = context.pages[-1]
        # Input '200' in the number input field
        ...
        # -> Click the calculate button to perform the percentage extraction calculation.
        frame = context.pages[-1]
        ...
        # -> Scroll down to check the operation history for the entry '200 * 20%'.
        ...
        try:
            ...
            raise AssertionError("Test case failed: The calculator did not accurately extract 20% of 200 as 40, and the operation '200 * 20%' was not correctly logged in the history.")
