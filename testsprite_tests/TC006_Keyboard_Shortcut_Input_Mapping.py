...
async def run_test():
    ...
    try:
        ...
        # -> Focus on the calculator input field and input digits 0-9 using keyboard to verify each digit appears correctly.
        frame = context.pages[-1]
        # Click on the 'آلة حاسبة' (Calculator) button to switch to calculator mode
