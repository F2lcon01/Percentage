...
async def run_test():
    ...
    try:
        ...
        # -> Input '25' in the percentage field (index 3) and '1000' in the number field (index 4), then press Enter to compute the result.
        frame = context.pages[-1]
        # Input 25 in the percentage field
        ...
        frame = context.pages[-1]
        # Input 1000 in the number field
        ...
        # -> Click the clear button (index 6) to clear inputs and results, then verify the fields and result are cleared.
        frame = context.pages[-1]
        # Click the clear button to clear inputs and results
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=٢٥٠').first).to_be_visible(timeout=30000)
