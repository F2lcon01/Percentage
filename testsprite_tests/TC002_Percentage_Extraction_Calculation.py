...
async def run_test():
    ...
    try:
        ...
        # -> Input '20' in the percentage field and '150' in the number field, then calculate.
        frame = context.pages[-1]
        # Input 20 in the percentage field
        ...
        # -> Use keyboard to input '20% of 150' equivalent expression in the input fields.
        frame = context.pages[-1]
        # Input 20 in the percentage field using keyboard
        elem = frame.locator('xpath=html/body/div/div/div/section/form/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('20')
        

        frame = context.pages[-1]
        # Input 150 in the number field using keyboard
        elem = frame.locator('xpath=html/body/div/div/div/section/form/div/div[2]/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('150')
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=٣٠').first).to_be_visible(timeout=30000)
